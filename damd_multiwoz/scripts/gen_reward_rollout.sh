...
per_epoch_report_path=${root_path}/data/multi-woz-oppe/reward/bspn_cntfact_contrast_reward_report_${K}_${metric}_${fold}_ratio_${ratio}_dp.csv
dev_list=${root_path}/data/multi-woz-processed/rewardListFile_${K}_${fold}.json

exp_name=bspn_cntfact_contrast_reward_K_${K}_fold_${fold}_metric_${metric}_seed_${seed}_CntfactRatio_${ratio}
